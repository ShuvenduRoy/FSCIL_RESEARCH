...
def init_distributed_mode(
    launcher: Literal["pytorch", "slurm"],
...
def launch_pytorch_dist(backend: Literal["nccl", "gloo", "mpi"]) -> None:
...
def launch_slurm_dist(backend: Literal["nccl", "gloo", "mpi"]) -> None:
...
def disable_non_master_print() -> None:
